...
'''
The Comments in these functions are generated by ChatGPT while the code is written by myself.
There is no guarantee therefore that the comments represent the Code.
...
def climatology_pred(df, start_year, end_year, window_length=30, variable="Tropical Storms"):
    ...
    - window_length (int, optional): Length of the window used for calculating climatological trends. Default is 30 Years.
